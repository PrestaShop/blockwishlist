...
namespace PrestaShop\Module\WishList\Tests\Unit\Core\Domain\Shop\ValueObject;
...
class ShopIdTest extends TestCase
{
    ...
    public function testItThrowsExceptionWhenInvalidValueIsGiven($invalidValue)
    {
        ...
        $this->expectExceptionCode(ShopConstraintException::INVALID_SHOP_ID);
