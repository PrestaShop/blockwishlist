...
class SearchOneWishListByCustomerQueryResultTest extends TestCase
{
    /**
    ...
    public function testItIsCreatedSuccessfullyWhenValidValueIsGiven($validValue)
    {
        $this->assertInstanceOf(
            SearchOneWishListByCustomerQueryResult::class,
    ...
    {
        return new SearchOneWishListByCustomerQueryResult(
            $data['customerId'],
            $data['shopId'],
            $data['shopGroupId'],
            $data['name'],
