...
class SearchAllWishListByCustomerQueryTest extends TestCase
{
    /**
    ...
    public function testItIsCreatedSuccessfullyWhenValidValueIsGiven($validValue)
    {
        $this->assertInstanceOf(
            SearchAllWishListByCustomerQuery::class,
     ...
     * @param array $data
     *
     * @return SearchAllWishListByCustomerQuery
     *
     * @throws CustomerConstraintException
     * @throws ShopConstraintException
     * @throws ShopGroupConstraintException
    ...
    {
        return new SearchAllWishListByCustomerQuery(
            $data['customerId'],
            $data['shopId'],
            $data['shopGroupId']
        );
