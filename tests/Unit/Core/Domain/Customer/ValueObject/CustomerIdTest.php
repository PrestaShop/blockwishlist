...
namespace PrestaShop\Module\WishList\Tests\Unit\Core\Domain\Customer\ValueObject;
...
class CustomerIdTest extends TestCase
{
    ...
    public function testItThrowsExceptionWhenInvalidValueIsGiven($invalidValue)
    {
        ...
        $this->expectExceptionCode(CustomerConstraintException::INVALID_CUSTOMER_ID);
