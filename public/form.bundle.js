 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */t.default=class{constructor(e){e=e||{},this.localeItemSelector=e.localeItemSelector||".js-locale-item",this.localeButtonSelector=e.localeButtonSelector||".js-locale-btn",this.localeInputSelector=e.localeInputSelector||".js-locale-input",i("body").on("click",this.localeItemSelector,this.toggleLanguage.bind(this)),o.on("languageSelected",this.toggleInputs.bind(this))}toggleLanguage(e){const t=i(e.target),n=t.closest("form");o.emit("languageSelected",{selectedLocale:t.data("locale"),form:n})}toggleInputs(e){const t=e.form,n=e.selectedLocale,r=t.find(this.localeButtonSelector),o=r.data("change-language-url");r.text(n),t.find(this.localeInputSelector).addClass("d-none"),t.find(`${this.localeInputSelector}.js-locale-${n}`).removeClass("d-none"),o&&this._saveSelectedLanguage(o,n)}_saveSelectedLanguage(e,t){i.post({url:e,data:{language_iso_code:t}})}}}});