...
{block name='page_content_container'}
  <div
    ...
    data-last-added="{l s='Last added' d='Modules.Blockwishlist.Shop'}"
    data-price-low-high="{l s='Price, low to high' d='Modules.Blockwishlist.Shop'}"
    data-price-high-low="{l s='Price, high to low' d='Modules.Blockwishlist.Shop'}"
    data-default-sort="{l s='Last added' d='Modules.Blockwishlist.Shop'}"
    data-title="{l s='Gift ideas for Juliette' d='Modules.Blockwishlist.Shop'}"
